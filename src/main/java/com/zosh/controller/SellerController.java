...
public class SellerController {
    ...
    public SellerController(SellerService sellerService, SellerReportService sellerReportService,
            EmailService emailService, VerificationCodeRepository verificationCodeRepository,
            VerificationService verificationService, JwtProvider jwtProvider,
    ...
    public ResponseEntity<ApiResponse> sentLoginOtp(@RequestBody VerificationCode req)
        ...
        String subject = "Fushion Nest Login Otp";
