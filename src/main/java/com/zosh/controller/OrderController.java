...
public class OrderController {
	...
	public OrderController(OrderService orderService, UserService userService, OrderItemService orderItemService,
			CartService cartService, PaymentService paymentService, PaymentOrderRepository paymentOrderRepository,
			SellerReportService sellerReportService, SellerService sellerService) {
