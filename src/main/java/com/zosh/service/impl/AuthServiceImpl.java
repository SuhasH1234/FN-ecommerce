...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthServiceImpl(UserService userService, VerificationCodeRepository verificationCodeRepository,
            EmailService emailService, PasswordEncoder passwordEncoder, UserRepository userRepository,
            JwtProvider jwtProvider, CustomeUserServiceImplementation customUserDetails,
    ...
    public void sentLoginOtp(String email) throws UserException, MessagingException {
        ...
        String subject = "Fushion Nest Login/Signup Otp";
